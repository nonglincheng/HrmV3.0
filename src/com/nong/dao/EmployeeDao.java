...
import static com.nong.util.common.HrmConstants.EMPLOYEETABLE;
...
import com.nong.dao.provider.EmployeeDynaSqlProvider;
...
public interface EmployeeDao {
	...
	@Results({
		...
		@Result(column="DEPT_ID",property="dept",
			one=@One(select="com.nong.dao.DeptDao.selectById",
		fetchType=FetchType.EAGER)),
		@Result(column="JOB_ID",property="job",
			one=@One(select="com.nong.dao.JobDao.selectById",
		fetchType=FetchType.EAGER))
	})
